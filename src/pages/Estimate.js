...
const defaultQuestions = [
  {
    ...
    options: [
      ...
      },
      {
        ...
        subtitle: null,
        icon: mobile,
        iconAlt: "phone and tablet outlines",
        selected: false,
        cost: 0,
      },
      {
  ...
  const softwareSelection = (
    <Grid container direction="column">
      ...
      >
        ...
        <Grid item xs={10}>
          <Typography variant="body1">
            {`The custom features will be of ${customFeatures.toLowerCase()}, and the project will be used by about ${user} users.`}
          </Typography>
        </Grid>
      </Grid>
    </Grid>
            ...
            >
              ...
              <Grid item>
                ...
                <Typography
                  ...
                  align={matchesSM ? "center" : undefined}
                >
                  Full out your name, phone number and email, place your
                  request, and we'll get bact to you with detail moving forword
                  and a final price.
                </Typography>
              </Grid>
            </Grid>
